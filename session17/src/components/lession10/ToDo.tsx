...
export const ToDo = () => {
	...
	const { todos, inputToDo, error, idAction, isDelete, isEdit, editContent } =
		state;
	...
	const onSaveToDo = (): void => {
		setState({
			...state,
			todos: todos.map((todo) =>
				todo.id === idAction ? { ...todo, content: editContent } : todo
			),
			editContent: "",
			idAction: "",
			isEdit: false,
	...
	return (
		<div className="container">
			...
			{isEdit && (
				<ModalEdit
					closeModalEdit={() =>
						setState({ ...state, isEdit: false, idAction: "" })
					}
